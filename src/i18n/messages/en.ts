export const messages = {
  ...
  ai: {
    toggle: 'AI Assistant',
    title: 'AI Assistant',
    placeholder: 'Ask about Typst, formulas, or paste code to improve...',
    send: 'Send',
    stop: 'Stop',
    clear: 'Clear chat',
    thinking: 'Thinking...',
    error: {
      noApiKey: 'Please configure your OpenAI API key in AI Settings.',
      requestFailed: 'Request failed. Please check your API key and try again.',
      notTauri: 'AI features are only available in the desktop app.',
    },
    settings: {
      title: 'AI Settings',
      apiKey: 'OpenAI API Key',
      apiKeyPlaceholder: 'sk-...',
      apiKeyHelp: 'Your key is stored securely in app memory and never persisted to disk.',
      apiKeySet: 'API key is set',
      apiKeyNotSet: 'No API key configured',
      model: 'Model',
      modelHelp: 'OpenAI model to use for completions',
      baseUrl: 'API Base URL',
      baseUrlHelp: 'Custom endpoint for OpenAI-compatible APIs',
      temperature: 'Temperature',
      temperatureHelp: 'Controls randomness (0 = deterministic, 1 = creative)',
      save: 'Save Settings',
      removeKey: 'Remove API Key',
      inlineCompletion: 'AI Inline Completion',
      inlineCompletionHelp: 'Press Ctrl+Space in the editor for AI-powered code completion',
    },
    inline: {
      trigger: 'AI Complete',
      loading: 'Getting AI suggestion...',
    },
    welcome: 'Hello! I\'m your Typst AI assistant. Ask me anything about Typst formulas, syntax, or paste code for improvement.',
    insertCode: 'Insert',
    copyCode: 'Copy',
  },
  math: {
