export const messages = {
  ...
  about: {
    ...
    features: {
      ...
      item4: 'Share links and local formula saves.',
    ...
    links: {
      ...
      im2typstModel: 'IBEM model on Hugging Face',
      im2typstSource: 'IBEM model source',
    },
  },
  notFound: {
  ...
  imageToTypst: {
    ...
    experimentalNotice: 'Best for one tightly cropped printed formula. Displayed and long formulas are less accurate, so verify every token against the image.',
    modelCard: 'Read model card',
    thirdPartyNotices: 'Third-party notices',
    localOnly: 'Image stays in this tab',
    modelReady: 'Model ready · {size}',
    ...
    issue: {
      ...
      'numeric-normalization': 'The output required numeric spacing normalization and was withheld for review.',
      'output-policy': 'The output fell outside the formula-only Typst safety policy.',
      'repetition-guard': 'The decoder entered a repeated-token loop and was stopped.',
      'syntax-repair': 'The output required automatic syntax repair and was withheld for review.',
    },
  },
  preview: {
    loading: {
